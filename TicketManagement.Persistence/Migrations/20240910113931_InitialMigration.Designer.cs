...
namespace TicketManagement.Persistence.Migrations
{
    ...
    [Migration("20240910113931_InitialMigration")]
            ...
            modelBuilder.Entity("TicketManagement.Domain.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Artist = "John Egbert",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2025, 3, 10, 12, 39, 31, 334, DateTimeKind.Local).AddTicks(9430),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2025, 6, 10, 12, 39, 31, 334, DateTimeKind.Local).AddTicks(9490),
                        ...
                        new
                        {
                            ...
                            Artist = "DJ 'The Mike'",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2025, 1, 10, 12, 39, 31, 334, DateTimeKind.Local).AddTicks(9500),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2025, 1, 10, 12, 39, 31, 334, DateTimeKind.Local).AddTicks(9510),
                        ...
                        new
                        {
                            ...
                            Artist = "Many",
                            CategoryId = new Guid("fe98f549-e790-4e9f-aa16-18c2292a2ee9"),
                            Date = new DateTime(2025, 7, 10, 12, 39, 31, 334, DateTimeKind.Local).AddTicks(9510),
                        ...
                        new
                        {
                            ...
                            Artist = "Nick Sailor",
                            CategoryId = new Guid("6313179f-7837-473a-a4d5-a5571b43e6a6"),
                            Date = new DateTime(2025, 5, 10, 12, 39, 31, 334, DateTimeKind.Local).AddTicks(9520),
            ...
            modelBuilder.Entity("TicketManagement.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 9, 10, 12, 39, 31, 334, DateTimeKind.Local).AddTicks(9530),
                            OrderTotal = 400,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 9, 10, 12, 39, 31, 334, DateTimeKind.Local).AddTicks(9540),
                            OrderTotal = 135,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 9, 10, 12, 39, 31, 334, DateTimeKind.Local).AddTicks(9550),
                            OrderTotal = 85,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 9, 10, 12, 39, 31, 334, DateTimeKind.Local).AddTicks(9560),
                            OrderTotal = 245,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 9, 10, 12, 39, 31, 334, DateTimeKind.Local).AddTicks(9570),
                            OrderTotal = 40,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 9, 10, 12, 39, 31, 334, DateTimeKind.Local).AddTicks(9580),
                            OrderTotal = 116,
                            UserId = new Guid("7aeb2c01-fe8e-4b84-a5ba-330bdf950f5c")
                        });
                });
